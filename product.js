...
let cartitemse1 = document.querySelector(".cartitems")
let subtotale1 = document.querySelector(".subtotal")
let itemsincarte1 = document.querySelector(".btn-white sup")
const food = [{
    id: 1,
    name: "Magnam Tiste",
    desc: "This content is a little bit longer.",
    price: 5.96,
    stock: 10,
    qty: 0
  },
  ...
  food.forEach((item) => {
    elementsel.innerHTML +=
      ...
      <div class="card h-100 border-0 bg-light">
        <img src="img/menu/${item.id}.png" class="img-fluid mx-auto d-block h-75 w-75" alt="...">
        <div class="card-body">
          <h5 class="card-title">${item.name}</h5>
          <p class="card-text text-muted">.${item.desc}</p>
          <h5 class="text-danger">$ ${item.price} <span class="ms-5"><button type="button" class="btn btn-danger" onclick=addtocart(${item.id})><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
                  <path
...
//                     <button type="button" class="btn btn-danger" onclick=addtocart(${item.id})><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
  ...
  cart.forEach((item) => {
    cartitemse1.innerHTML +=
      ` <table class="table w-100">
                           <tbody>
                           <tr><td><img src="img/menu/${item.id}.png" height="50" width="50"></td>
...
function rendersubtotal() {
  ...
  itemsincarte1.innerHTML = totalitems;
}
